...
class Conv: public Layer {
 ...
 public:
  Conv(int type, int channel_in, int height_in, int width_in, int channel_out,
  ...
  //multiply 2 matrix base on which type of convo
  Matrix multiply(const Matrix& data_col, const Matrix& weight);
