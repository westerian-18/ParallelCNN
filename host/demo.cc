...
int main() {
  ...
  // dnn
  Network dnn;
  Layer* conv1 = new Conv(1, 1, 28, 28, 6, 5, 5, 1, 0, 0);
  Layer* pool1 = new MaxPooling(6, 24, 24, 2, 2, 2);
  Layer* conv2 = new Conv(2, 6, 12, 12, 16, 5, 5, 1, 0, 0);
  ...
  /*
  Network dnn;
  Layer* conv1 = new Conv(1, 1, 28, 28, 4, 5, 5, 2, 2, 2);
  Layer* pool1 = new MaxPooling(4, 14, 14, 2, 2, 2);
  Layer* conv2 = new Conv(1, 4, 7, 7, 16, 5, 5, 1, 2, 2);
